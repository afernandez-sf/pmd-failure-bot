...
public class PmdReport {
    ...
    // Store compressed content as BYTEA to reduce storage footprint
    ...
    public String getContent() {
        ...
        try {
            ...
            // Fallback: if not gzipped, attempt direct decode
            try {
    ...
    public void setContent(String contentString) {
        ...
        try {
            ...
            // Fallback: store raw bytes if compression fails
