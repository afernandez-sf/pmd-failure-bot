...
public class QueryResponseFactory {
    ...
    public NaturalLanguageQueryResponse createSuccessResponse(String content,
    ...
    public NaturalLanguageQueryResponse createErrorResponse(String errorMessage,
                                                            QueryRequest request,
                                                            String conversationId,
                                                            long executionTimeMs) {
        NaturalLanguageQueryResponse response = new NaturalLanguageQueryResponse(
            errorMessage,
            request != null ? request : new QueryRequest(),
            List.of(),
            0.0,
            LocalDateTime.now(),
            executionTimeMs
