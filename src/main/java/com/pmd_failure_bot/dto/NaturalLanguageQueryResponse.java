...
public class NaturalLanguageQueryResponse {
    ...
    public QueryRequest getExtractedParameters() {
        return extractedParameters;
    }
    
    public void setExtractedParameters(QueryRequest extractedParameters) {
        this.extractedParameters = extractedParameters;
    }
    
    public List<QueryResponse.ReportInfo> getReportsFound() {
        return reportsFound;
    }
    
    public void setReportsFound(List<QueryResponse.ReportInfo> reportsFound) {
        this.reportsFound = reportsFound;
    }
    
    public Double getParameterExtractionConfidence() {
        return parameterExtractionConfidence;
    }
    
    public void setParameterExtractionConfidence(Double parameterExtractionConfidence) {
        this.parameterExtractionConfidence = parameterExtractionConfidence;
    }
